...
Dim command As New clsStringBuilder
...
Private Sub Listview_Programs_KeyPress(KeyAscii As Integer)
If KeyAscii = vbKeyReturn Then: Call Listview_Programs_DblClick
End Sub
